    ...
    return (
      ...
      <div className="stats max-sm:inline-block shadow">
        <div className="stat place-items-center w-80">
          ...
          <CountUp className='stat-value' duration={5} end={12000} enableScrollSpy={true}>
          </CountUp>
          <div className="stat-desc">From January 1st to December last</div>
        </div>

        <div className="stat place-items-center w-72">
          <div className="stat-title">Books To Read</div>
          <CountUp className='text-blue-500 stat-value' duration={5} end={4200} enableScrollSpy={true}>
          </CountUp>
        ...
        <div className="stat place-items-center w-72">
          ...
          <CountUp className='stat-value' duration={5} end={1250} enableScrollSpy={true}>
          </CountUp>
        ...
        <div className="stat place-items-center w-72">
          ...
          <CountUp className='stat-value' duration={5} end={45} enableScrollSpy={true}>
          </CountUp>
          <div className="stat-desc">↘︎ 90 (14%)</div>
        </div>
      </div>

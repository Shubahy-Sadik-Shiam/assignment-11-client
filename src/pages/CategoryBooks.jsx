...
const CategoryBooks = () => {
    ...
    return (
        <div>
            <h2 className="text-center bg-gradient-to-r from-yellow-100 via-pink-200 to-yellow-300 text-4xl font-bold py-10">Where Every Story Begins: A Grand Book Collection</h2>
